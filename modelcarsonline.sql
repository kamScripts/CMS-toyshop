...
--
-- Host: localhost:3306
-- Generation Time: Apr 19, 2026 at 11:34 AM
...
--
-- Database: `kamscrip_carmodelsonline`
--
...
(8, 'testUser', 'test@gmail.com', '$2y$10$.kd5GAHiDNJoVoSnjT1MWu7T6ULezKVWEuaUR1YGufqnGH9Uq9fbe'),
(9, 'kamil10', 'gmail@gmail.com', '$2y$10$Want3ymJQTi1Dbc7E4dUaO.VoDwkCrivFkuJN7fNPl0TcIyir5Oua'),
(10, 'newUser', 'user@gmail.com', '$2y$10$LrEEOHb9DO57MRTP4ZbWYOzigkPBMSFTgNk7UKczH0dcnpKjvoKMS');
...
(25, 10, 'super fast', NULL, 50.00, 3, 'ferarri.png');
...
--
ALTER TABLE `scale`
  MODIFY `scale_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `variant`
  MODIFY `variant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
